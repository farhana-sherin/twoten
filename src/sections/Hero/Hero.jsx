...
const Hero = () => {
    return (
        <section id="home" className="relative w-full min-h-screen pt-28 pb-14 px-6 md:px-12 lg:px-16 flex flex-col justify-between overflow-hidden text-white font-['Plus_Jakarta_Sans'] bg-[#050507]">
            <Navbar />

            {/* 50/50 Equal Balance Grid */}
            <div className="max-w-[1360px] mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-center my-auto pt-6 z-10">
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-xs font-bold tracking-[0.22em] text-amber-400 uppercase font-['Plus_Jakarta_Sans']">
                            Digital Marketing Solutions
                        </span>
                    </motion.div>

                    {/* Main Title - Ultra-Bold Condensed Upper-case Font matching reference image */}
                    <motion.h1
                    ...
                    >
                        We combine strategy, creativity and data to help brands connect, engage and grow in the digital world.
                    </motion.p>
                    ...
                    >
                        ...
                        <button className="flex items-center gap-3 text-xs font-bold tracking-wider text-white hover:text-amber-300 border border-white/20 hover:border-amber-400/50 transition-all px-5 py-3.5 rounded-lg bg-white/5 backdrop-blur-md cursor-pointer group font-['Plus_Jakarta_Sans']">
                            <div className="w-5 h-5 rounded-full border border-white/30 flex items-center justify-center group-hover:border-amber-400 transition-colors">
                                <Play size={9} className="ml-0.5 fill-white text-white group-hover:fill-amber-400 group-hover:text-amber-400" />
                            </div>
                            WATCH SHOWREEL
                        </button>
                    </motion.div>
